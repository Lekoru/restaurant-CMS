      ...
      >
        <div className=" pt-5 px-md-5 ps-3 ">
          ...
          <table className="table d-none d-lg-inline" style={{}}>
            <thead className="">
              <tr className="">
                <th scope="col" className="border-0 py-3 col-2">
                  Date from
                </th>
                <th scope="col" className="border-0 py-3 col-2">
                  Date to
          ...
          {/*  */}
          <th className="ps-3 py-3 d-none d-lg-block" scope="row">
            <span
          ...
          >
            ...
            >
              <tr className="">
                <th scope="col" className="border-0 py-3 ps-5 col-2">
                  ID
                </th>
                <th scope="col" className="border-0 py-3 col-2">
                  Created
            ...
            <tbody>
              {[1].map((item, index) => (
                ...
                >
                  <th className="ps-3 py-3" scope="row">
                    <span
                  ...
                  <td className="py-4 fs-13">Thurs, June 24, 2021 10:06 AM</td>
                  <td className="py-4 fs-13">
                    <div className="">10:40 AM - 11:20 AM</div>
                  </td>
                  <td className="py-4 fs-13 fw-bold flex" id="action">
                    {' '}
                    <div className="">
                      <span
              ...
              {[1].map((item, index) => (
                ...
                >
                  ...
                  <td className="py-4 fs-13  flex" id="action">
                    <div className="">NO ACTIONS RIGHT NOW!</div>
                  </td>
                  ...
                  <td className="py-3 mt-3">
                    <div className="">
                      <span className=" status-prepared">Prepared</span>
                    </div>
                  </td>
                </tr>
              ))}
